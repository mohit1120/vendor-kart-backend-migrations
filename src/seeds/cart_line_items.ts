...
async function seedCartLineItems() {
  try {
    await CartLineItems.bulkCreate([
      { 
        PID: "cart_line_item_1659a988-3181-48c3-887c-67c9c244cli001",  // Unique PID
        CartID: "cart_1659a988-3181-48c3-887c-67c9c244c001", 
      ...
      { 
        PID: "cart_line_item_1659a988-3181-48c3-887c-67c9c244cli002",  // Unique PID
        CartID: "cart_1659a988-3181-48c3-887c-67c9c244c001", 
        UserID: "user_1659a988-3181-48c3-887c-67c9c244e446", 
      ...
      { 
        PID: "cart_line_item_1659a988-3181-48c3-887c-67c9c244cli003",  // Unique PID
        CartID: "cart_1659a988-3181-48c3-887c-67c9c244c002", 
      ...
      { 
        PID: "cart_line_item_1659a988-3181-48c3-887c-67c9c244cli004",  // Unique PID
        CartID: "cart_1659a988-3181-48c3-887c-67c9c244c003", 
      ...
      { 
        PID: "cart_line_item_1659a988-3181-48c3-887c-67c9c244cli005",  // Unique PID
        CartID: "cart_1659a988-3181-48c3-887c-67c9c244c003", 
        UserID: "user_1659a988-3000-48c3-887c-67c9c244e321", 
